...
module.exports = function(controller) {
    ...
    const DIALOG_ID = 'calculate-fundability-dialog';
                ...
                try {
                    ...
                    Logger.log({
                        ...
                        metadata : {
                            ...
                            intent : "calculate_fundability_intent"
                        }
                    })
    ...
    convo.after(async (results, bot) => {
        Logger.log({
            level : "info",
            message : "END of conversation : calculate_fundability_intent",
            metadata : {
                convo : false,
    ...
    controller.on('message, direct_message', async (bot, message) => {
        ...
        if(message.intent === "calculate_fundability_intent"){
            ...
            Logger.log({
                level : "info",
                message : "START of conversation : calculate_fundability_intent",
                metadata : {
                    convo : true,
